...
persists Dev Tunnel connect tokens and Jupyter tokens to disk, writes each caller's own managed SSH
configuration under `<state>/hosts/<principal>/config`, and executes
